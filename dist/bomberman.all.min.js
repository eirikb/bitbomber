(function(){var b=this,e=b._,i={},h=Array.prototype,k=Object.prototype,j=h.slice,o=h.unshift,m=k.toString,p=k.hasOwnProperty,q=h.forEach,u=h.map,t=h.reduce,s=h.reduceRight,x=h.filter,z=h.every,w=h.some,A=h.indexOf,C=h.lastIndexOf;k=Array.isArray;var F=Object.keys,d=function(a){return new y(a)};if(typeof module!=="undefined"&&module.exports){module.exports=d;d._=d}else b._=d;d.VERSION="1.1.4";var v=d.each=d.forEach=function(a,c,f){if(a!=null)if(q&&a.forEach===q)a.forEach(c,f);else if(d.isNumber(a.length))for(var g=
0,l=a.length;g<l;g++){if(c.call(f,a[g],g,a)===i)break}else for(g in a)if(p.call(a,g))if(c.call(f,a[g],g,a)===i)break};d.map=function(a,c,f){var g=[];if(a==null)return g;if(u&&a.map===u)return a.map(c,f);v(a,function(l,n,r){g[g.length]=c.call(f,l,n,r)});return g};d.reduce=d.foldl=d.inject=function(a,c,f,g){var l=f!==void 0;if(a==null)a=[];if(t&&a.reduce===t){if(g)c=d.bind(c,g);return l?a.reduce(c,f):a.reduce(c)}v(a,function(n,r,G){if(!l&&r===0){f=n;l=true}else f=c.call(g,f,n,r,G)});if(!l)throw new TypeError("Reduce of empty array with no initial value");
return f};d.reduceRight=d.foldr=function(a,c,f,g){if(a==null)a=[];if(s&&a.reduceRight===s){if(g)c=d.bind(c,g);return f!==void 0?a.reduceRight(c,f):a.reduceRight(c)}a=(d.isArray(a)?a.slice():d.toArray(a)).reverse();return d.reduce(a,c,f,g)};d.find=d.detect=function(a,c,f){var g;D(a,function(l,n,r){if(c.call(f,l,n,r)){g=l;return true}});return g};d.filter=d.select=function(a,c,f){var g=[];if(a==null)return g;if(x&&a.filter===x)return a.filter(c,f);v(a,function(l,n,r){if(c.call(f,l,n,r))g[g.length]=
l});return g};d.reject=function(a,c,f){var g=[];if(a==null)return g;v(a,function(l,n,r){c.call(f,l,n,r)||(g[g.length]=l)});return g};d.every=d.all=function(a,c,f){c=c||d.identity;var g=true;if(a==null)return g;if(z&&a.every===z)return a.every(c,f);v(a,function(l,n,r){if(!(g=g&&c.call(f,l,n,r)))return i});return g};var D=d.some=d.any=function(a,c,f){c=c||d.identity;var g=false;if(a==null)return g;if(w&&a.some===w)return a.some(c,f);v(a,function(l,n,r){if(g=c.call(f,l,n,r))return i});return g};d.include=
d.contains=function(a,c){var f=false;if(a==null)return f;if(A&&a.indexOf===A)return a.indexOf(c)!=-1;D(a,function(g){if(f=g===c)return true});return f};d.invoke=function(a,c){var f=j.call(arguments,2);return d.map(a,function(g){return(c?g[c]:g).apply(g,f)})};d.pluck=function(a,c){return d.map(a,function(f){return f[c]})};d.max=function(a,c,f){if(!c&&d.isArray(a))return Math.max.apply(Math,a);var g={computed:-Infinity};v(a,function(l,n,r){n=c?c.call(f,l,n,r):l;n>=g.computed&&(g={value:l,computed:n})});
return g.value};d.min=function(a,c,f){if(!c&&d.isArray(a))return Math.min.apply(Math,a);var g={computed:Infinity};v(a,function(l,n,r){n=c?c.call(f,l,n,r):l;n<g.computed&&(g={value:l,computed:n})});return g.value};d.sortBy=function(a,c,f){return d.pluck(d.map(a,function(g,l,n){return{value:g,criteria:c.call(f,g,l,n)}}).sort(function(g,l){var n=g.criteria,r=l.criteria;return n<r?-1:n>r?1:0}),"value")};d.sortedIndex=function(a,c,f){f=f||d.identity;for(var g=0,l=a.length;g<l;){var n=g+l>>1;f(a[n])<f(c)?
...
a.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(f.interpolate,function(g,l){return"',"+l.replace(/\\'/g,"'")+",'"}).replace(f.evaluate||null,function(g,l){return"');"+l.replace(/\\'/g,"'").replace(/[\r\n\t]/g," ")+"__p.push('"}).replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');";f=new Function("obj",f);return c?f(c):f};var y=function(a){this._wrapped=a};d.prototype=y.prototype;var B=function(a,c){return c?d(a).chain():a},H=function(a,c){y.prototype[a]=function(){var f=
j.call(arguments);o.call(f,this._wrapped);return B(c.apply(d,f),this._chain)}};d.mixin(d);v(["pop","push","reverse","shift","sort","splice","unshift"],function(a){var c=h[a];y.prototype[a]=function(){c.apply(this._wrapped,arguments);return B(this._wrapped,this._chain)}});v(["concat","join","slice"],function(a){var c=h[a];y.prototype[a]=function(){return B(c.apply(this._wrapped,arguments),this._chain)}});y.prototype.chain=function(){this._chain=true;return this};y.prototype.value=function(){return this._wrapped}})();
...
OGE.World.prototype.getBodies=function(b,e,i,h){var k,j;k=j=b;if(arguments.length===1){j=k.x;e=k.y;i=k.width;h=k.height}j=j<0?0:j;j=j+i>this.width?this.width-i:j;e=e<0?0:e;e=e+h>this.height?this.height-h:e;k=[];j=this.getZones(j,e,i,h);for(var o=0;o<j.length;o++)for(var m=j[o].bodies,p=0;p<m.length;p++){for(var q=m[p],u=false,t=0;t<k.length;t++)if(k[t]===q){u=true;break}u||k.push(q)}return k};
OGE.World.prototype.getZones=function(b,e,i,h){var k,j;k=j=b;if(arguments.length===1){j=k.x;e=k.y;i=k.width;h=k.height}if(j>=0&&j+i-1<this.width&&e>=0&&e+h-1<this.height){k=(j+i)/this.zoneSize<<0;var o=e/this.zoneSize<<0,m=(e+h)/this.zoneSize<<0,p=0,q=[];for(j=j/this.zoneSize<<0;j<=k;j++)for(e=o;e<=m;e++)q[p++]=this.zones[j][e];return q}else return[]};
...
OGE.World.prototype.moveBody=function(b,e,i){var h,k,j;if(arguments.length===1){e=b.direction;i=b.speed}for(var o=0;o<i;o++){h=b.x;k=b.y;this.removeBodyFromZones(b);b.x+=e.cos;b.y+=e.sin;j=this.getBodies(b);for(var m=0;m<j.length;m++){var p=j[m];if(b!==p&&!p.intersects(h,k,b.width,b.height)&&p.intersects(b)){var q=b.collide(p)===true;p=p.collide(b)===true;if(q&&p){b.x=h;b.y=k;this.addBodyToZones(b);if(b.slide&&m>=0)this.slideBody(b,e);else return}}}this.addBodyToZones(b)}};
OGE.World.prototype.slideBody=function(b,e){var i=this,h=function(j){var o=[],m=i.getBodies(b),p,q,u,t,s,x;for(q=0;q<m.length;q++){s=m[q];s!==b&&s.intersects(b)&&o.push(s)}p=0;u=b.x+j.cos*1.9<<0;if(u!==b.x)u=b.x+(u>b.x?1:-1);t=b.y+j.sin*1.9<<0;if(t!==b.y)t=b.y+(t>b.y?1:-1);m=i.getBodies(u,t,b.width,b.height);for(q=0;q<m.length;q++){s=m[q];if(s!==b&&s.intersects(u,t,b.width,b.height)){x=false;for(j=0;j<o.length;j++)if(s===o[j]){x=true;break}x||(p+=s.intersection(u,t,b.width,b.height))}}return p<<0},
...
Game.prototype.explodeBomb=function(b,e){if(arguments.length===1)e={x:b.x,y:b.y,bodies:[],fires:[]};var i=b.size*b.width,h=b.size*b.height,k=this;this.removeBody(b);var j=function(m,p,q){e.fires[m]||(e.fires[m]=[]);e.fires[m][p]||(e.fires[m][p]=q)};j(b.x,b.y,"c");var o=function(m,p,q,u,t){for(m=b.x+m;m<=b.x+q;m+=b.width)for(var s=b.y+p;s<=b.y+u;s+=b.height)if(m>=0&&s>=0&&m<k.world.width&&s<k.world.height)for(var x=k.world.getBodies(m,s,b.width,b.height),z=0;z<x.length;z++){var w=x[z];if(w!==b&&w.intersects(m,
s,b.width,b.height)){_.contains(e.bodies,w)||e.bodies.push(w);if(w.armor>=b.power){if(e.fires[m]&&e.fires[m][s])e.fires[m][s]=null;return}else k.removeBody(w);w instanceof Bomb&&k.explodeBomb(w,e)}j(m,s,t)}};o(-i,0,-b.width,0,"l");o(+b.width,0,+i,0,"r");o(0,-h,0,-b.height,"u");o(0,+b.height,0,+h,"d");return e};
...
Game.deserialize=function(b){var e=new Game(b.width,b.height),i=function(h){if(b[h].pos.length>0){var k=b[h].size,j=Math.floor(b.width/k);_.each(b[h].pos,function(o){var m=new Box(o%j*k,Math.floor(o/j)*k,k,k);_.each(b[h].attrs,function(p,q){m[q]=b[h].attrs[q]});e[h].push(m);e.addBody(m)})}};i("blocks");i("bricks");b.players&&b.players.length>0&&_.each(b.players,function(h){e.addBody(Player.deserialize(h),true)});return e};
