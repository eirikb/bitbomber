...
Powerup=function(){OGE.Body.apply(this,arguments)};Powerup.prototype=Object.construct_prototype(OGE.Body);Game=function(b,e){this.world=new OGE.World(b,e,16);this.players=[];this.bombs=[];this.fires=[];this.blocks=[];this.bricks=[];this.maxPlayers=4};Game.prototype.removeBoxes=function(b,e){var i=this;_.each(e.bodies,function(h){h instanceof Box&&h.armor===b.power&&i.removeBody(h)})};
