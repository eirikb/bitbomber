(function(){var b=this,e=b._,i={},h=Array.prototype,k=Object.prototype,j=h.slice,o=h.unshift,m=k.toString,p=k.hasOwnProperty,r=h.forEach,t=h.map,w=h.reduce,u=h.reduceRight,z=h.filter,y=h.every,v=h.some,A=h.indexOf,C=h.lastIndexOf;k=Array.isArray;var F=Object.keys,d=function(a){return new x(a)};if(typeof module!=="undefined"&&module.exports){module.exports=d;d._=d}else b._=d;d.VERSION="1.1.4";var s=d.each=d.forEach=function(a,c,f){if(a!=null)if(r&&a.forEach===r)a.forEach(c,f);else if(d.isNumber(a.length))for(var g=
0,l=a.length;g<l;g++){if(c.call(f,a[g],g,a)===i)break}else for(g in a)if(p.call(a,g))if(c.call(f,a[g],g,a)===i)break};d.map=function(a,c,f){var g=[];if(a==null)return g;if(t&&a.map===t)return a.map(c,f);s(a,function(l,n,q){g[g.length]=c.call(f,l,n,q)});return g};d.reduce=d.foldl=d.inject=function(a,c,f,g){var l=f!==void 0;if(a==null)a=[];if(w&&a.reduce===w){if(g)c=d.bind(c,g);return l?a.reduce(c,f):a.reduce(c)}s(a,function(n,q,G){if(!l&&q===0){f=n;l=true}else f=c.call(g,f,n,q,G)});if(!l)throw new TypeError("Reduce of empty array with no initial value");
...
g=n+1:l=n}return g};d.toArray=function(a){if(!a)return[];if(a.toArray)return a.toArray();if(d.isArray(a))return a;if(d.isArguments(a))return j.call(a);return d.values(a)};d.size=function(a){return d.toArray(a).length};d.first=d.head=function(a,c,f){return c&&!f?j.call(a,0,c):a[0]};d.rest=d.tail=function(a,c,f){return j.call(a,d.isUndefined(c)||f?1:c)};d.last=function(a){return a[a.length-1]};d.compact=function(a){return d.filter(a,function(c){return!!c})};d.flatten=function(a){return d.reduce(a,function(c,
...
OGE.World.prototype.getBodies=function(b,e,i,h){var k,j;k=j=b;if(arguments.length===1){j=k.x;e=k.y;i=k.width;h=k.height}j=j<0?0:j;j=j+i>this.width?this.width-i:j;e=e<0?0:e;e=e+h>this.height?this.height-h:e;k=[];j=this.getZones(j,e,i,h);for(var o=0;o<j.length;o++)for(var m=j[o].bodies,p=0;p<m.length;p++){for(var r=m[p],t=false,w=0;w<k.length;w++)if(k[w]===r){t=true;break}t||k.push(r)}return k};
...
Game.prototype.explodeBomb=function(b,e){if(arguments.length===1)e={x:b.x,y:b.y,bodies:[],fires:[]};var i=b.size*b.width,h=b.size*b.height,k=this;this.removeBody(b);var j=function(m,p,r){e.fires[m]||(e.fires[m]=[]);e.fires[m][p]||(e.fires[m][p]=r)};j(b.x,b.y,"c");var o=function(m,p,r,t,w){for(m=b.x+m;m<=b.x+r;m+=b.width)for(var u=b.y+p;u<=b.y+t;u+=b.height)if(m>=0&&u>=0&&m<k.world.width&&u<k.world.height)for(var z=k.world.getBodies(m,u,b.width,b.height),y=0;y<z.length;y++){var v=z[y];if(v!==b&&v.intersects(m,
u,b.width,b.height)){_.contains(e.bodies,v)||e.bodies.push(v);if(v.armor>=b.power){e.fires[m][u]=null;return}else k.removeBody(v);v instanceof Bomb&&k.explodeBomb(v,e)}j(m,u,w)}};o(-i,0,-b.width,0,"l");o(+b.width,0,+i,0,"r");o(0,-h,0,-b.height,"u");o(0,+b.height,0,+h,"d");return e};
