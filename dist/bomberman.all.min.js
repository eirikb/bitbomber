(function(){var b=this,c=b._,g={},f=Array.prototype,k=Object.prototype,i=f.slice,m=f.unshift,n=k.toString,q=k.hasOwnProperty,r=f.forEach,w=f.map,l=f.reduce,x=f.reduceRight,u=f.filter,z=f.every,v=f.some,A=f.indexOf,t=f.lastIndexOf;k=Array.isArray;var C=Object.keys,e=function(a){return new D(a)};if(typeof module!=="undefined"&&module.exports){module.exports=e;e._=e}else b._=e;e.VERSION="1.1.4";var B=e.each=e.forEach=function(a,d,h){if(a!=null)if(r&&a.forEach===r)a.forEach(d,h);else if(e.isNumber(a.length))for(var j=
0,o=a.length;j<o;j++){if(d.call(h,a[j],j,a)===g)break}else for(j in a)if(q.call(a,j))if(d.call(h,a[j],j,a)===g)break};e.map=function(a,d,h){var j=[];if(a==null)return j;if(w&&a.map===w)return a.map(d,h);B(a,function(o,s,y){j[j.length]=d.call(h,o,s,y)});return j};e.reduce=e.foldl=e.inject=function(a,d,h,j){var o=h!==void 0;if(a==null)a=[];if(l&&a.reduce===l){if(j)d=e.bind(d,j);return o?a.reduce(d,h):a.reduce(d)}B(a,function(s,y,H){if(!o&&y===0){h=s;o=true}else h=d.call(j,h,s,y,H)});if(!o)throw new TypeError("Reduce of empty array with no initial value");
return h};e.reduceRight=e.foldr=function(a,d,h,j){if(a==null)a=[];if(x&&a.reduceRight===x){if(j)d=e.bind(d,j);return h!==void 0?a.reduceRight(d,h):a.reduceRight(d)}a=(e.isArray(a)?a.slice():e.toArray(a)).reverse();return e.reduce(a,d,h,j)};e.find=e.detect=function(a,d,h){var j;F(a,function(o,s,y){if(d.call(h,o,s,y)){j=o;return true}});return j};e.filter=e.select=function(a,d,h){var j=[];if(a==null)return j;if(u&&a.filter===u)return a.filter(d,h);B(a,function(o,s,y){if(d.call(h,o,s,y))j[j.length]=
o});return j};e.reject=function(a,d,h){var j=[];if(a==null)return j;B(a,function(o,s,y){d.call(h,o,s,y)||(j[j.length]=o)});return j};e.every=e.all=function(a,d,h){d=d||e.identity;var j=true;if(a==null)return j;if(z&&a.every===z)return a.every(d,h);B(a,function(o,s,y){if(!(j=j&&d.call(h,o,s,y)))return g});return j};var F=e.some=e.any=function(a,d,h){d=d||e.identity;var j=false;if(a==null)return j;if(v&&a.some===v)return a.some(d,h);B(a,function(o,s,y){if(j=d.call(h,o,s,y))return g});return j};e.include=
e.contains=function(a,d){var h=false;if(a==null)return h;if(A&&a.indexOf===A)return a.indexOf(d)!=-1;F(a,function(j){if(h=j===d)return true});return h};e.invoke=function(a,d){var h=i.call(arguments,2);return e.map(a,function(j){return(d?j[d]:j).apply(j,h)})};e.pluck=function(a,d){return e.map(a,function(h){return h[d]})};e.max=function(a,d,h){if(!d&&e.isArray(a))return Math.max.apply(Math,a);var j={computed:-Infinity};B(a,function(o,s,y){s=d?d.call(h,o,s,y):o;s>=j.computed&&(j={value:o,computed:s})});
return j.value};e.min=function(a,d,h){if(!d&&e.isArray(a))return Math.min.apply(Math,a);var j={computed:Infinity};B(a,function(o,s,y){s=d?d.call(h,o,s,y):o;s<j.computed&&(j={value:o,computed:s})});return j.value};e.sortBy=function(a,d,h){return e.pluck(e.map(a,function(j,o,s){return{value:j,criteria:d.call(h,j,o,s)}}).sort(function(j,o){var s=j.criteria,y=o.criteria;return s<y?-1:s>y?1:0}),"value")};e.sortedIndex=function(a,d,h){h=h||e.identity;for(var j=0,o=a.length;j<o;){var s=j+o>>1;h(a[s])<h(d)?
j=s+1:o=s}return j};e.toArray=function(a){if(!a)return[];if(a.toArray)return a.toArray();if(e.isArray(a))return a;if(e.isArguments(a))return i.call(a);return e.values(a)};e.size=function(a){return e.toArray(a).length};e.first=e.head=function(a,d,h){return d!=null&&!h?i.call(a,0,d):a[0]};e.rest=e.tail=function(a,d,h){return i.call(a,d==null||h?1:d)};e.last=function(a){return a[a.length-1]};e.compact=function(a){return e.filter(a,function(d){return!!d})};e.flatten=function(a){return e.reduce(a,function(d,
h){if(e.isArray(h))return d.concat(e.flatten(h));d[d.length]=h;return d},[])};e.without=function(a){var d=i.call(arguments,1);return e.filter(a,function(h){return!e.include(d,h)})};e.uniq=e.unique=function(a,d){return e.reduce(a,function(h,j,o){if(0==o||(d===true?e.last(h)!=j:!e.include(h,j)))h[h.length]=j;return h},[])};e.intersect=function(a){var d=i.call(arguments,1);return e.filter(e.uniq(a),function(h){return e.every(d,function(j){return e.indexOf(j,h)>=0})})};e.zip=function(){for(var a=i.call(arguments),
...
1;for(var j=Math.max(Math.ceil((d-a)/h),0),o=0,s=Array(j);o<j;){s[o++]=a;a+=h}return s};e.bind=function(a,d){var h=i.call(arguments,2);return function(){return a.apply(d||{},h.concat(i.call(arguments)))}};e.bindAll=function(a){var d=i.call(arguments,1);if(d.length==0)d=e.functions(a);B(d,function(h){a[h]=e.bind(a[h],a)});return a};e.memoize=function(a,d){var h={};d=d||e.identity;return function(){var j=d.apply(this,arguments);return q.call(h,j)?h[j]:h[j]=a.apply(this,arguments)}};e.delay=function(a,
d){var h=i.call(arguments,2);return setTimeout(function(){return a.apply(a,h)},d)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(i.call(arguments,1)))};var G=function(a,d,h){var j;return function(){var o=this,s=arguments,y=function(){j=null;a.apply(o,s)};h&&clearTimeout(j);if(h||!j)j=setTimeout(y,d)}};e.throttle=function(a,d){return G(a,d,false)};e.debounce=function(a,d){return G(a,d,true)};e.wrap=function(a,d){return function(){var h=[a].concat(i.call(arguments));return d.apply(this,h)}};
e.compose=function(){var a=i.call(arguments);return function(){for(var d=i.call(arguments),h=a.length-1;h>=0;h--)d=[a[h].apply(this,d)];return d[0]}};e.keys=C||function(a){var d=[],h;for(h in a)if(q.call(a,h))d[d.length]=h;return d};e.values=function(a){return e.map(a,e.identity)};e.functions=e.methods=function(a){return e.filter(e.keys(a),function(d){return e.isFunction(a[d])}).sort()};e.extend=function(a){B(i.call(arguments,1),function(d){for(var h in d)a[h]=d[h]});return a};e.clone=function(a){return e.isArray(a)?
...
d.multiline;if(h!=="object")return false;if(a.length&&a.length!==d.length)return false;h=e.keys(a);var j=e.keys(d);if(h.length!=j.length)return false;for(var o in a)if(!(o in d)||!e.isEqual(a[o],d[o]))return false;return true};e.isEmpty=function(a){if(e.isArray(a)||e.isString(a))return a.length===0;for(var d in a)if(q.call(a,d))return false;return true};e.isElement=function(a){return!!(a&&a.nodeType==1)};e.isArray=k||function(a){return n.call(a)==="[object Array]"};e.isArguments=function(a){return!!(a&&
q.call(a,"callee"))};e.isFunction=function(a){return!!(a&&a.constructor&&a.call&&a.apply)};e.isString=function(a){return!!(a===""||a&&a.charCodeAt&&a.substr)};e.isNumber=function(a){return!!(a===0||a&&a.toExponential&&a.toFixed)};e.isNaN=function(a){return a!==a};e.isBoolean=function(a){return a===true||a===false};e.isDate=function(a){return!!(a&&a.getTimezoneOffset&&a.setUTCFullYear)};e.isRegExp=function(a){return!!(a&&a.test&&a.exec&&(a.ignoreCase||a.ignoreCase===false))};e.isNull=function(a){return a===
...
OGE.World.prototype.getBodies=function(b,c,g,f){var k,i;k=i=b;if(arguments.length===1){i=k.x;c=k.y;g=k.width;f=k.height}i=i<0?0:i;i=i+g>this.width?this.width-g:i;c=c<0?0:c;c=c+f>this.height?this.height-f:c;k=[];i=this.getZones(i,c,g,f);for(var m=0;m<i.length;m++)for(var n=i[m].bodies,q=0;q<n.length;q++){for(var r=n[q],w=false,l=0;l<k.length;l++)if(k[l]===r){w=true;break}w||k.push(r)}return k};
OGE.World.prototype.getZones=function(b,c,g,f){var k,i;k=i=b;if(arguments.length===1){i=k.x;c=k.y;g=k.width;f=k.height}if(i>=0&&i+g-1<this.width&&c>=0&&c+f-1<this.height){k=(i+g)/this.zoneSize<<0;var m=c/this.zoneSize<<0,n=(c+f)/this.zoneSize<<0,q=0,r=[];for(i=i/this.zoneSize<<0;i<=k;i++)for(c=m;c<=n;c++)r[q++]=this.zones[i][c];return r}else return[]};
...
OGE.World.prototype.moveBody=function(b,c,g){var f,k,i;if(arguments.length===1){c=b.direction;g=b.speed}for(var m=0;m<g;m++){f=b.x;k=b.y;this.removeBodyFromZones(b);b.x+=c.cos;b.y+=c.sin;if(b.x>=0&&b.y>=0&&b.x+b.width<this.width&&b.y+b.height<this.height){i=this.getBodies(b);for(var n=0;n<i.length;n++){var q=i[n];if(b!==q&&!q.intersects(f,k,b.width,b.height)&&q.intersects(b)){var r=b.collide(q)===true;q=q.collide(b)===true;if(r&&q){b.x=f;b.y=k;this.addBodyToZones(b);if(b.slide&&n>=0)this.slideBody(b,
c);else return}}}this.addBodyToZones(b)}else{b.x=f;b.y=k;break}}};
OGE.World.prototype.slideBody=function(b,c){var g=this,f=function(i){var m=[],n=g.getBodies(b),q,r,w,l,x,u;for(r=0;r<n.length;r++){x=n[r];x!==b&&x.intersects(b)&&m.push(x)}q=0;w=b.x+i.cos*1.9<<0;if(w!==b.x)w=b.x+(w>b.x?1:-1);l=b.y+i.sin*1.9<<0;if(l!==b.y)l=b.y+(l>b.y?1:-1);n=g.getBodies(w,l,b.width,b.height);for(r=0;r<n.length;r++){x=n[r];if(x!==b&&x.intersects(w,l,b.width,b.height)){u=false;for(i=0;i<m.length;i++)if(x===m[i]){u=true;break}u||(q+=x.intersection(w,l,b.width,b.height))}}return q<<0},
...
Game.prototype.explodeBomb=function(b,c){if(arguments.length===1)c={x:b.x,y:b.y,bodies:[],fires:[],bombs:[]};var g=this,f=function(i,m,n){var q=function(r){return r.x===i&&r.y===m};if(typeof _.detect(c.bodies,q)==="undefined"){n={x:i,y:m,firevar:n};q=_.detect(c.fires,q);if(typeof q!=="undefined"){if(q.firevar!=="c"&&_.contains("c","v","h",n.firevar)){c.fires=_.without(c.fires,q);c.fires.push(n)}}else c.fires.push(n)}};c.bombs.push(b);f(b.x,b.y,"c");var k=function(i,m,n,q){i=i*b.width;var r=b.x+i,
...
LobbyPanel=function(b){var c=$("#loginPanel"),g=$("#loginButton"),f=$("#lobbyPanel"),k=$("#nickField"),i=$("#playNowButton"),m=$("#createGameButton"),n=function(){b.createGame(function(w){w&&f.hide()})},q=function(){b.playNow(function(){f.hide()})},r=function(){k.val().length>0&&b.login(k.val(),function(w){if(w){c.hide();f.show()}else{k.focus();c.children("span").text("Nick taken!")}})};(function(){k.keypress(function(w){if(w.keyCode===13){k.blur();r()}});g.click(function(){r()});i.click(function(){q()});
m.click(function(){n()});k.focus()})()};
GameHandler=function(b,c){var g,f,k;listeners={};this.addListener=function(i,m){if(typeof listeners[i]==="undefined")listeners[i]=[];listeners[i].push(m)};this.removeBody=function(i){g.removeBody(i)};this.startGame=function(i,m){g=i;f=g.getPlayer(m);k=new FactorialTimer;var n=(new Date).getTime(),q;k.start(function(){n=(new Date).getTime()-n;q=(new Date).getTime();g.world.step();q=(new Date).getTime()-q;var r=Math.floor(1E3/n);_.each(listeners.step,function(w){w(n,r,q)});n=(new Date).getTime()});
...
_.each(listeners.placeBomb,function(q){q(n)})});c.addListener("explodeBomb",function(i,m){var n=g.getBomb(m.x,m.y);g.getPlayer(m.player).bombs++;if(n!==null){m=g.explodeBomb(n);g.removeBodies(m.bombs,Bomb);if(_.include(m.bodies,f)){_.each(listeners.meDead,function(){});f.x=0;f.y=0;c.send("playerDead",{})}_.each(listeners.explodeBomb,function(q){q(n,m)})}});c.addListener("playerDead",function(i,m){var n=g.getPlayer(m.player);n.x=0;n.y=0;_.each(listeners.playerDead,function(){})});c.addListener("resurectPlayer",
function(i,m){var n=g.getPlayer(m.player);g.addBody(n);_.each(listeners.resurectPlayer,function(q){q(n)})})};SocketClient=function(){var b=new io.Socket,c={};this.addListener=function(g,f){if(typeof c[g]==="undefined")c[g]=[];c[g].push(f)};this.send=function(g,f){b.send({cmd:g,data:f})};b.connect();b.on("message",function(g){utils.log(g);_.each(c[g.cmd],function(f){f(g.result,g.data)})})};
GamePanel=function(b){var c=$("#gamePanel"),g=$("#fpsLabel"),f,k=[],i=[];b.addListener("startGame",function(l){f=new KeyboardHandler;c.find("*").remove();c.show();c.width(l.world.width).height(l.world.height);_.each(l.blocks,function(u){m(u,"objects")});_.each(l.bricks,function(u){m(u,"objects");u.offsetSprite=1;w(u)});_.each(l.players,function(u){n(u)});f.keydown(function(u){var z=0,v=0;switch(u){case "space":(u=b.placeBomb())&&q(u);break;case "left":z=-1;break;case "up":v=-1;break;case "right":z=
...
v.sprites=[0,1,2,3];v.offsetSprite=A;v.animate=5;k.push(v)});_.each(z.bodies,function(v){if(v instanceof Box){v.animate=5;v.sprite=0;v.offsetSprite=1;v.sprites=[1,2];v.animateTimer=10;i.push(v)}else v instanceof Bomb&&v.$img.remove()})})});b.addListener("addPlayer",function(l){n(l)});b.addListener("placeBomb",function(l){q(l)});b.addListener("meDead",function(l){l.$img.remove()});b.addListener("playerDead",function(l){l.$img.remove()});b.addListener("resurectPlayer",function(l){c.append(l.$img)});
var m=function(l,x){var u=$("<div>").css("background","url(images/"+x+".png)").css("left",l.x).css("top",l.y).addClass("body");l.$img=u;l.sprite=0;l.offsetSprite=0;l.animate=0;l.animateCount=0;l.sprites=[0];l.animateTimer=5;w(l);c.append(u);return u},n=function(l){m(l,"pb").addClass("player");l.sprites=[0,1,0,2]},q=function(l){m(l,"objects");l.sprites=[0,1,2];l.animate=5;l.offsetSprite=2},r=function(l){l.direction!==null&&l.speed>0&&l.$img.css("left",l.x).css("top",l.y-4);if(l.animate>0){if(l.lastDirection!==
