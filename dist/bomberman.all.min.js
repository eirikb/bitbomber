(function(){var b=this,e=b._,i={},h=Array.prototype,k=Object.prototype,j=h.slice,n=h.unshift,o=k.toString,p=k.hasOwnProperty,r=h.forEach,u=h.map,s=h.reduce,y=h.reduceRight,x=h.filter,v=h.every,B=h.some,z=h.indexOf,C=h.lastIndexOf;k=Array.isArray;var F=Object.keys,d=function(a){return new w(a)};if(typeof module!=="undefined"&&module.exports){module.exports=d;d._=d}else b._=d;d.VERSION="1.1.4";var t=d.each=d.forEach=function(a,c,f){if(a!=null)if(r&&a.forEach===r)a.forEach(c,f);else if(d.isNumber(a.length))for(var g=
0,l=a.length;g<l;g++){if(c.call(f,a[g],g,a)===i)break}else for(g in a)if(p.call(a,g))if(c.call(f,a[g],g,a)===i)break};d.map=function(a,c,f){var g=[];if(a==null)return g;if(u&&a.map===u)return a.map(c,f);t(a,function(l,m,q){g[g.length]=c.call(f,l,m,q)});return g};d.reduce=d.foldl=d.inject=function(a,c,f,g){var l=f!==void 0;if(a==null)a=[];if(s&&a.reduce===s){if(g)c=d.bind(c,g);return l?a.reduce(c,f):a.reduce(c)}t(a,function(m,q,G){if(!l&&q===0){f=m;l=true}else f=c.call(g,f,m,q,G)});if(!l)throw new TypeError("Reduce of empty array with no initial value");
return f};d.reduceRight=d.foldr=function(a,c,f,g){if(a==null)a=[];if(y&&a.reduceRight===y){if(g)c=d.bind(c,g);return f!==void 0?a.reduceRight(c,f):a.reduceRight(c)}a=(d.isArray(a)?a.slice():d.toArray(a)).reverse();return d.reduce(a,c,f,g)};d.find=d.detect=function(a,c,f){var g;D(a,function(l,m,q){if(c.call(f,l,m,q)){g=l;return true}});return g};d.filter=d.select=function(a,c,f){var g=[];if(a==null)return g;if(x&&a.filter===x)return a.filter(c,f);t(a,function(l,m,q){if(c.call(f,l,m,q))g[g.length]=
l});return g};d.reject=function(a,c,f){var g=[];if(a==null)return g;t(a,function(l,m,q){c.call(f,l,m,q)||(g[g.length]=l)});return g};d.every=d.all=function(a,c,f){c=c||d.identity;var g=true;if(a==null)return g;if(v&&a.every===v)return a.every(c,f);t(a,function(l,m,q){if(!(g=g&&c.call(f,l,m,q)))return i});return g};var D=d.some=d.any=function(a,c,f){c=c||d.identity;var g=false;if(a==null)return g;if(B&&a.some===B)return a.some(c,f);t(a,function(l,m,q){if(g=c.call(f,l,m,q))return i});return g};d.include=
d.contains=function(a,c){var f=false;if(a==null)return f;if(z&&a.indexOf===z)return a.indexOf(c)!=-1;D(a,function(g){if(f=g===c)return true});return f};d.invoke=function(a,c){var f=j.call(arguments,2);return d.map(a,function(g){return(c?g[c]:g).apply(g,f)})};d.pluck=function(a,c){return d.map(a,function(f){return f[c]})};d.max=function(a,c,f){if(!c&&d.isArray(a))return Math.max.apply(Math,a);var g={computed:-Infinity};t(a,function(l,m,q){m=c?c.call(f,l,m,q):l;m>=g.computed&&(g={value:l,computed:m})});
return g.value};d.min=function(a,c,f){if(!c&&d.isArray(a))return Math.min.apply(Math,a);var g={computed:Infinity};t(a,function(l,m,q){m=c?c.call(f,l,m,q):l;m<g.computed&&(g={value:l,computed:m})});return g.value};d.sortBy=function(a,c,f){return d.pluck(d.map(a,function(g,l,m){return{value:g,criteria:c.call(f,g,l,m)}}).sort(function(g,l){var m=g.criteria,q=l.criteria;return m<q?-1:m>q?1:0}),"value")};d.sortedIndex=function(a,c,f){f=f||d.identity;for(var g=0,l=a.length;g<l;){var m=g+l>>1;f(a[m])<f(c)?
g=m+1:l=m}return g};d.toArray=function(a){if(!a)return[];if(a.toArray)return a.toArray();if(d.isArray(a))return a;if(d.isArguments(a))return j.call(a);return d.values(a)};d.size=function(a){return d.toArray(a).length};d.first=d.head=function(a,c,f){return c&&!f?j.call(a,0,c):a[0]};d.rest=d.tail=function(a,c,f){return j.call(a,d.isUndefined(c)||f?1:c)};d.last=function(a){return a[a.length-1]};d.compact=function(a){return d.filter(a,function(c){return!!c})};d.flatten=function(a){return d.reduce(a,function(c,
...
OGE.World.prototype.getBodies=function(b,e,i,h){var k,j;k=j=b;if(arguments.length===1){j=k.x;e=k.y;i=k.width;h=k.height}j=j<0?0:j;j=j+i>this.width?this.width-i:j;e=e<0?0:e;e=e+h>this.height?this.height-h:e;k=[];j=this.getZones(j,e,i,h);for(var n=0;n<j.length;n++)for(var o=j[n].bodies,p=0;p<o.length;p++){for(var r=o[p],u=false,s=0;s<k.length;s++)if(k[s]===r){u=true;break}u||k.push(r)}return k};
OGE.World.prototype.getZones=function(b,e,i,h){var k,j;k=j=b;if(arguments.length===1){j=k.x;e=k.y;i=k.width;h=k.height}if(j>=0&&j+i-1<this.width&&e>=0&&e+h-1<this.height){k=(j+i)/this.zoneSize<<0;var n=e/this.zoneSize<<0,o=(e+h)/this.zoneSize<<0,p=0,r=[];for(j=j/this.zoneSize<<0;j<=k;j++)for(e=n;e<=o;e++)r[p++]=this.zones[j][e];return r}else return[]};
...
OGE.World.prototype.moveBody=function(b,e,i){var h,k,j;if(arguments.length===1){e=b.direction;i=b.speed}for(var n=0;n<i;n++){h=b.x;k=b.y;this.removeBodyFromZones(b);b.x+=e.cos;b.y+=e.sin;j=this.getBodies(b);for(var o=0;o<j.length;o++){var p=j[o];if(b!==p&&!p.intersects(h,k,b.width,b.height)&&p.intersects(b)){var r=b.collide(p)===true;p=p.collide(b)===true;if(r&&p){b.x=h;b.y=k;this.addBodyToZones(b);if(b.slide&&o>=0)this.slideBody(b,e);else return}}}this.addBodyToZones(b)}};
OGE.World.prototype.slideBody=function(b,e){var i=this,h=function(j){var n=0,o=b.x+j.cos*1.9<<0;if(o!==b.x)o=b.x+(o>b.x?1:-1);j=b.y+j.sin*1.9<<0;if(j!==b.y)j=b.y+(j>b.y?1:-1);for(var p=i.getBodies(o,j,b.width,b.height),r=0;r<p.length;r++){var u=p[r];if(u!==b&&u.intersects(o,j,b.width,b.height))n+=u.intersection(o,j,b.width,b.height)}return n<<0},k=h(e.clone().rotate(-45));h=h(e.clone().rotate(45));if(k<h)this.moveBody(b,e.clone().rotate(-90),1);else k>h&&this.moveBody(b,e.clone().rotate(90),1)};
Object.construct_prototype=function(b){var e=function(){};e.prototype=b.prototype;return new e};Player=function(b,e,i,h,k){this.nick=k;if(arguments.length===1)this.nick=arguments[0];OGE.Body.apply(this,arguments);this.speed=3;this.slide=true;this.bombPower=this.bombSize=1;this.life=3;this.armor=0;this.bombs=1};Player.prototype=Object.construct_prototype(OGE.Body);Player.prototype.serialize=function(){return{nick:this.nick,x:this.x,y:this.y,width:this.width,height:this.height,speed:this.speed,armor:this.armor}};
...
Powerup=function(){OGE.Body.apply(this,arguments)};Powerup.prototype=Object.construct_prototype(OGE.Body);Game=function(b,e){this.world=new OGE.World(b,e,16);this.players=[];this.bombs=[];this.fires=[];this.blocks=[];this.bricks=[];this.maxPlayers=4};Game.prototype.getBomb=function(b,e){for(var i=0;i<this.bombs.length;i++)if(this.bombs[i].x===b&&this.bombs[i].y===e)return this.bombs[i];return null};
Game.prototype.removeBoxes=function(b,e){var i=this;_.each(e.bodies,function(h){h instanceof Box&&h.armor===b.power&&i.removeBody(h)})};
Game.prototype.explodeBomb=function(b,e){if(arguments.length===1)e={x:b.x,y:b.y,bodies:[],fires:[]};var i=b.size*b.width,h=b.size*b.height,k=this;this.removeBody(b);var j=function(n,o,p,r,u){for(n=b.x+n;n<=b.x+p;n+=b.width)for(var s=b.y+o;s<=b.y+r;s+=b.height)if(n>=0&&s>=0&&n<k.world.width&&s<k.world.height)for(var y=k.world.getBodies(n,s,b.width,b.height),x=0;x<y.length;x++){var v=y[x];if(v!==b&&v.intersects(n,s,b.width,b.height)){_.contains(e.bodies,v)||e.bodies.push(v);if(v.armor>=b.power)return;
else{k.removeBody(v);e.fires[n]||(e.fires[n]=[]);e.fires[n][s]||(e.fires[n][s]=u)}v instanceof Bomb&&k.explodeBomb(v,e)}}};j(-i,0,-b.width,0,"l");j(+b.width,0,+i,0,"r");j(0,-h,0,-b.height,"u");j(0,+b.height,0,+h,"d");return e};Game.prototype.addBody=function(b,e){if(!this.world.addBody(b,e))return false;if(b instanceof Player){if(this.players.length==this.maxPlayers)return false;else if(this.players.length===0)this.owner=b;this.players.push(b)}else b instanceof Bomb&&this.bombs.push(b);return true};
Game.prototype.serialize=function(){var b=this,e={width:this.world.width,height:this.world.height},i=function(h,k){if(b[h].length>0){var j=b[h][0].width;e[h]={};e[h].size=j;e[h].pos=[];e[h].attrs={};_.each(b[h],function(n){e[h].pos.push(n.y/j*Math.floor(b.world.width/j)+n.x/j);_.each(k,function(o){e[h].attrs[o]=n[o]})})}};if(this.players.length>0){e.players=[];_.each(this.players,function(h){e.players.push(h.serialize())})}i("blocks",["armor"]);i("bricks");return e};
