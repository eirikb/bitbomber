...
utils.log=function(b,c){if(arguments.length===1){c=b;b=c.cmd}typeof console!=="undefined"&&console!==null&&console.log(b,c);c=b+" - "+c.result;$infoArea.val($infoArea.val()+($infoArea.val().length>0?"\n":"")+c);$infoArea.attr("scrollTop",$infoArea.attr("scrollHeight"))};$(function(){$infoArea=$("#infoArea");var b=new HttpClient,c=new SocketClient,g=new GameHandler(f,c),f=new LobbyHandler(g,b,c);new GamePanel(g);new LobbyPanel(f)});
