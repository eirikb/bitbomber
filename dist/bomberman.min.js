...
OGE.World.prototype.moveBody=function(a,b,c){var d,f,e;if(arguments.length===1){b=a.direction;c=a.speed}for(var g=0;g<c;g++){d=a.x;f=a.y;this.removeBodyFromZones(a);a.x+=b.cos;a.y+=b.sin;e=this.getBodies(a);for(var h=0;h<e.length;h++){var j=e[h];if(a!==j&&!j.intersects(d,f,a.width,a.height)&&j.intersects(a)){var i=a.collide(j)===true;j=j.collide(a)===true;if(i&&j){a.x=d;a.y=f;this.addBodyToZones(a);if(a.slide&&h>=0)this.slideBody(a,b);else return}}}this.addBodyToZones(a)}};
