...
utils.log=function(a,b){if(arguments.length===1){b=a;a=b.cmd}typeof console!=="undefined"&&console!==null&&console.log(a,b);b=a+" - "+b.result;$infoArea.val($infoArea.val()+($infoArea.val().length>0?"\n":"")+b);$infoArea.attr("scrollTop",$infoArea.attr("scrollHeight"))};$(function(){$infoArea=$("#infoArea");var a=new HttpClient,b=new SocketClient,c=new GameHandler(d,b),d=new LobbyHandler(c,a,b);new GamePanel(c);new LobbyPanel(d)});
