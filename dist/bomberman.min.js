...
OGE.World.prototype.slideBody=function(a,b){var c=this,d=function(e){var g=[],h=c.getBodies(a),j,i,k,l,m,n;for(i=0;i<h.length;i++){m=h[i];m!==a&&m.intersects(a)&&g.push(m)}j=0;k=a.x+e.cos*1.9<<0;if(k!==a.x)k=a.x+(k>a.x?1:-1);l=a.y+e.sin*1.9<<0;if(l!==a.y)l=a.y+(l>a.y?1:-1);h=c.getBodies(k,l,a.width,a.height);for(i=0;i<h.length;i++){m=h[i];if(m!==a&&m.intersects(k,l,a.width,a.height)){n=false;for(e=0;e<g.length;e++)if(m===g[e]){n=true;break}n||(j+=m.intersection(k,l,a.width,a.height))}}return j<<0},
...
Game.prototype.explodeBomb=function(a,b){if(arguments.length===1)b={x:a.x,y:a.y,bodies:[],fires:[]};var c=this,d=function(e,g,h){var j=function(i){return i.x===e&&i.y===g};if(typeof _.detect(b.bodies,j)==="undefined"){h={x:e,y:g,firevar:h};j=_.detect(b.fires,j);if(typeof j!=="undefined"){if(j.firevar!=="c"&&_.contains("c","v","h",h.firevar)){b.fires=_.without(b.fires,j);b.fires.push(h)}}else b.fires.push(h)}};this.removeBody(a);d(a.x,a.y,"c");var f=function(e,g,h,j){e=e*a.width;var i=a.x+e,k=a.x+
a.size*e;g=g*a.height;var l=a.y+g,m=a.y+a.size*g;actualCheck=function(n,p,s){if(n>=0&&p>=0&&n<c.world.width&&p<c.world.height){for(var r=c.world.getBodies(n,p,a.width,a.height),q=0;q<r.length;q++){var o=r[q];if(o!==a&&o.intersects(n+2,p+2,a.width-2,a.height-2)){if(o.armor>a.power)return false;else{!(o instanceof Bomb)&&!_.contains(b.bodies,o)&&b.bodies.push(o);if(o.armor===a.power)return false}o instanceof Bomb&&c.explodeBomb(o,b)}}d(n,p,s)}return true};for(i=i;i!==k+e;i+=e)if(!actualCheck(i,a.y,
