...
utils.log=function(a){if(a.cmd&&a.result){typeof console!=="undefined"&&console!==null&&console.log(a.cmd,a);a=a.cmd+" - "+a.result}else typeof console!=="undefined"&&console!==null&&console.log(a);$infoArea.val($infoArea.val()+($infoArea.val().length>0?"\n":"")+a);$infoArea.attr("scrollTop",$infoArea.attr("scrollHeight"))};var bomberman=function(){new LobbyHandler(this);var a=new GameHandler(this);this.startGame=function(b,d){a.startGame(b,d)};this.login=function(b){a.login(b)}};
$(function(){$infoArea=$("#infoArea");bomberman()});
